...
public class Employee extends javax.swing.JPanel {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            Statement s = db.myCon().createStatement();
            s.executeUpdate(" UPDATE employee SET name='"+name+"', tp='"+tp+"', addr='"+adr+"', shipping_addr='"+ship+"', bank='"+bnk+"', city='"+cty+"', c_name='"+c_name+"', c_per='"+c_per+"', c_tp='"+c_tp+"', c_email='"+c_email+"', c_online='"+c_online+"' WHERE eid='"+id+"'");
            cname.setText("");
            ctp.setText("");
            addr.setText("");
            type.setText("");
    ...
    private void csearchtblcityKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_csearchtblcityKeyReleased
        ...
        try {
            ...
            Statement s = db.myCon().createStatement();
            ResultSet rs = s.executeQuery("SELECT * FROM employee WHERE city LIKE '%"+city+"%'");
    ...
    private void csearchtbltpKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_csearchtbltpKeyReleased
        ...
        try {
            ...
            Statement s = db.myCon().createStatement();
            ResultSet rs = s.executeQuery("SELECT * FROM employee WHERE tp LIKE '%"+tp+"%'");
    ...
    private void csearchtblemailKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_csearchtblemailKeyReleased
        ...
        try {
            ...
            Statement s = db.myCon().createStatement();
            ResultSet rs = s.executeQuery("SELECT * FROM employee WHERE c_email LIKE '%"+email+"%'");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        ReportView rw = new ReportView("src\\reports\\employee.jasper",map);
        rw.setVisible(true);
