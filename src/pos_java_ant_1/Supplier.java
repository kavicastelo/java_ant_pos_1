...
public class Supplier extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            Statement s = db.myCon().createStatement();
            s.executeUpdate(" INSERT INTO supplier (name,tp,addr,type,c_per,c_tp) VALUES ('"+name+"','"+tp+"','"+adr+"','"+typ+"','"+c_per+"','"+c_tp+"')");
            cname.setText("");
            ctp.setText("");
            addr.setText("");
            type.setText("");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            Statement s = db.myCon().createStatement();
            s.executeUpdate(" UPDATE supplier SET name='"+name+"', tp='"+tp+"', addr='"+adr+"', type='"+typ+"', c_per='"+c_per+"', c_tp='"+c_tp+"' WHERE sid='"+id+"'");
            cname.setText("");
            ctp.setText("");
            addr.setText("");
            type.setText("");
